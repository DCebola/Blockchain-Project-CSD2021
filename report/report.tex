...
\begin{document}
	...
	In Section 7 we evaluate the current state of the BGWS system, its correctness, limitations and tradeofs.
	Finally, in Section 7 we conclude the document and mention future work.\cite{nakamoto2019bitcoin}
