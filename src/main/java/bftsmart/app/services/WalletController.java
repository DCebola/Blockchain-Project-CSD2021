...
import main.java.bftsmart.app.models.Wallet;
...
public class WalletController implements WalletService {
    ...
    private Map<String, main.java.bftsmart.app.models.Wallet> wallets;
    ...
    public double obtainCoins(String who, double amount) {
        main.java.bftsmart.app.models.Wallet wallet = wallets.get(who);
